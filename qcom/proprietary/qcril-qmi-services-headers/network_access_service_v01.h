...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //commercial/MPSS.HE.1.5.c4/Main/modem_proc/qmimsgs/nas/api/network_access_service_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define NAS_V01_IDL_MINOR_VERS 0xF6
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define NAS_V01_MAX_MESSAGE_ID 0x00E8
/**
    @}
  */
...
typedef enum {
  ...
  NAS_GPRS_PS_NOT_SUPPORTED_V01 = 0, 
  NAS_GPRS_PS_SUPPORTED_V01 = 1, 
  NAS_GPRS_PS_SUPPORT_UNKNOWN_V01 = 2, 
...
typedef struct {
  ...
  /**<   Enable/Disable ENDC
        Values: \n
        0x00 - Disable ENDC addition
        0x01 - Enable ENDC addition
    */
...
typedef struct {
  ...
  /**<   Get ENDC status
        Values: \n
        0x00 - ENDC addition is disabled
        0x01 - ENDC addition is enabled
    */
