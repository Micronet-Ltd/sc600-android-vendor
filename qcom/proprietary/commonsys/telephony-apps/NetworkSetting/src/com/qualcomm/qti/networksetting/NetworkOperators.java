...
public class NetworkOperators extends PreferenceCategory
    ...
    public void initialize() {
        ...
        mSharedPreferences = getContext().getSharedPreferences(TRI_KEY, Context.MODE_PRIVATE);
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case EVENT_AUTO_SELECT_DONE:
                    ...
                    dismissProgressBar();
                    mSharedPreferences.edit().putInt("triggernetworksetting", 0).commit();
    ...
    private void selectNetworkAutomatic(boolean autoSelect) {
        ...
        if (autoSelect) {
            ...
            mSharedPreferences.edit().putInt("triggernetworksetting", 1).commit();
        }
    }
