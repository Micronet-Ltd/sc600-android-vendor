...
public class DeviceInfo extends PreferenceActivity {
    ...
    private void setPreferenceSummary() {
        ...
        if (mPhone != null) {
            ...
            //get imei
            setSummaryText(KEY_IMEI_NUMBER_1, PhoneFactory.
                    getPhone(PhoneConstants.SUB1).getImei());
            setSummaryText(KEY_IMEI_NUMBER_2, PhoneFactory.
                    getPhone(PhoneConstants.SUB2).getImei());
        }
