...
const std::map<std::string, std::map<BasebandRevisionEnum, PmcRegisterInfo>> PmcRegistersAccessor::s_pmcRegisterMap
{
     ...
     {"USER.CLKS_CTL.SW.RST.USER_USER_CLKS_CTL_SW_RST_VEC_0", {{ BasebandRevisionEnum::TLN_M_B0, PmcRegisterInfo{0x880b04 ,0, 31}}}},
     {"USER.EXTENTION.USER_USER_EXTENTION_3.mac_pmc_clk_sw_bypass_hw", {{ BasebandRevisionEnum::TLN_M_B0, PmcRegisterInfo{0x880C20 ,9, 9}}}},
     {"USER.EXTENTION.USER_USER_EXTENTION_3.mac_prp_ahb_rgs_hclk_sw_bypass_hw", {{ BasebandRevisionEnum::TLN_M_B0, PmcRegisterInfo{0x880C20 ,16, 16}}}},
     ...
     {"MAC_EXT_RGF.MAC_SXD_EXT.PMC_UCODE_WR_RANGE.MAC_EXT_MAC_EXT_RGF_MAC_SXD_EXT_PMC_UCODE_WR_RANGE_0.sxd_pmc_start_1", {{BasebandRevisionEnum::TLN_M_B0, PmcRegisterInfo{0x88C1BC ,0, 7}}}},
     {"MAC_EXT_RGF.MAC_SXD_EXT.PMC_UCODE_WR_RANGE.MAC_EXT_MAC_EXT_RGF_MAC_SXD_EXT_PMC_UCODE_WR_RANGE_0.sxd_pmc_end_1", {{BasebandRevisionEnum::TLN_M_B0, PmcRegisterInfo{0x88C1BC ,8, 15}}}},
     {"MAC_EXT_RGF.MAC_SXD_EXT.PMC_UCODE_WR_RANGE.MAC_EXT_MAC_EXT_RGF_MAC_SXD_EXT_PMC_UCODE_WR_RANGE_0.sxd_pmc_start_2", {{BasebandRevisionEnum::TLN_M_B0, PmcRegisterInfo{0x88C1BC ,16, 23}}}},
     {"MAC_EXT_RGF.MAC_SXD_EXT.PMC_UCODE_WR_RANGE.MAC_EXT_MAC_EXT_RGF_MAC_SXD_EXT_PMC_UCODE_WR_RANGE_0.sxd_pmc_end_2", {{BasebandRevisionEnum::TLN_M_B0, PmcRegisterInfo{0x88C1BC ,24, 31}}}},
