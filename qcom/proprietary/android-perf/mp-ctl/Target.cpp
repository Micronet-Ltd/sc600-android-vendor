...
#define PROPERTY_PREDEFINED_CLUSTER_MAP "vendor.perflocks.predefined_clust_map"
#define PROPERTY_PREDEFINED_FREQUENCY_MAP "vendor.perflocks.predefined_freq_map"
