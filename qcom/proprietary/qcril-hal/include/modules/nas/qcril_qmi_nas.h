...
/*=========================================================================
  FUNCTION:  qcril_qmi_nas_request_allow_data_wrapper

===========================================================================*/
void qcril_qmi_nas_request_allow_data_wrapper(
...
===========================================================================*/
bool qcril_qmi_nas_is_gcf_card_present_in_slot(uint8_t slot, RIL_CardStatus_v6 *ril_card_status);
...
#ifndef TARGET_USES_QCOM_BSP_ATEL
RIL_Errno qcril_qmi_nas_update_dds_sub_id(int dds_sub);
#else
