...
#ifndef VENDOR_QTI_HARDWARE_QTIRADIO_V2_3_QTIRADIO_H
#define VENDOR_QTI_HARDWARE_QTIRADIO_V2_3_QTIRADIO_H

//Since we have no UTF support for QtiRadioV2.3, disable compilation only for UTF.
//v2.3 is still functional on target.
#ifndef QMI_RIL_UTF
...
#ifndef QMI_RIL_UTF
class QtiRadioImpl : public V2_3::IQtiRadio, public hidl_death_recipient {
#else
...
#endif // VENDOR_QTI_HARDWARE_QTIRADIO_V2_3_QTIRADIO_H
