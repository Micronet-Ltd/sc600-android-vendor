...
)
{
  ...
  auto      rsp_data_ptr = std::shared_ptr<qmi_cat_sync_rsp_data_type>(new qmi_cat_sync_rsp_data_type{});
  char      stk_logging_of_private_data_prop_val[PROPERTY_VALUE_MAX] = {0};
  ...
  property_get(QCRIL_GSTK_PRIVACY_LOGGING_PROPERTY,
               stk_logging_of_private_data_prop_val,
               QCRIL_GSTK_PRIVACY_LOGGING_ENABLED);

  if (strcmp(stk_logging_of_private_data_prop_val, QCRIL_GSTK_PRIVACY_LOGGING_ENABLED) == 0)
  {
