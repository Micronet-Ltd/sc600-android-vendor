...
typedef struct {
  ...
  uint8_t flag;
  voice_sups_notification_ind_msg_v02 *msg;
} qcril_qmi_voice_sups_notif_cache;

#define QCRIL_QMI_VOICE_FLAG_SUPS_NOTIF_CACHE_NONE             ((uint8_t) 0)
#define QCRIL_QMI_VOICE_FLAG_SUPS_NOTIF_CACHE_RIL_CLIENT_READY (((uint8_t) 1) << 0)
#define QCRIL_QMI_VOICE_FLAG_SUPS_NOTIF_CACHE_IMS_CLIENT_READY (((uint8_t) 1) << 1)
...
void qcril_qmi_map_verstat_info_to_ims(
