  ...
  mct_event_t* event)
{
  ...
  case MCT_EVENT_MODULE_EVENT: {
    ...
    case MCT_EVENT_MODULE_FRAME_DROP_NOTIFY:
      CPP_BUF_DBG("Frame Drop identity=0x%x frame_id %d enable_post_cpp %d",
  ...
  bool force)
{
  ...
  /* For QM215, cpp clock is restricted to NOM */
  if (ctrl->soc_id == SOC_ID_QM215 && (rounded_clk_rate > 320000000)) {
