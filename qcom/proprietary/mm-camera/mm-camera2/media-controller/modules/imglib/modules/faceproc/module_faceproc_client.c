  ...
  int s_idx)
{
  ...
  IDBG_HIGH("STREAM_CROP : frame_id=%d, session_id=%d, stream_id=%d, "
    ...
    stream_crop->is_w_margin, stream_crop->is_h_margin);
  ...
  p_fp_stream->is_w_margin = stream_crop->is_w_margin;
  p_fp_stream->is_h_margin = stream_crop->is_h_margin;
  ...
  faceproc_stream_t *p_to_stream)
{
  ...
  if (p_from->is_w_margin || p_to_stream->is_w_margin) {
    p_to_stream->camif_out_trans_info.h_scale =
      (p_from->camif_out_trans_info.h_scale *
  ...
  if (p_from->is_h_margin || p_to_stream->is_h_margin) {
    p_to_stream->camif_out_trans_info.v_scale =
      (p_from->camif_out_trans_info.v_scale *
