 ...
 **/
static unsigned int s5k4h7_real_to_register_gain(float real_gain)
{
 ...
 **/
static float s5k4h7_register_to_real_gain(unsigned int reg_gain)
{
    float real_gain;
...
/**
 * FUNCTION: s5k4h7_digital_gain_calc
 *
