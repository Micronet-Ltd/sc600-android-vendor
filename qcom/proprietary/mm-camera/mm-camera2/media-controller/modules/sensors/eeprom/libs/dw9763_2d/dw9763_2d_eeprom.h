...
#define PDGAIN_FLAG        0x0715  //0x0711
#define PDGAIN             (PDGAIN_FLAG + 1)
#define DCC_FLAG            0x0A91  //0x0d99
#define DCC_OFFSET         (DCC_FLAG+1)
...
static eeprom_lib_func_t dw9763_2d_eeprom_lib_func_ptr = {
  .get_calibration_items = dw9763_2d_eeprom_get_calibration_items,
  .format_calibration_data = dw9763_2d_eeprom_format_calibration_data,
  .do_af_calibration = dw9763_2d_autofocus_calibration,
      ...
      {
        {
          ...
          .mem_settings =
          {
            { 0x00, CAMERA_I2C_WORD_ADDR,
              3486, CAMERA_I2C_BYTE_DATA, CAMERA_I2C_OP_READ, 0 },
