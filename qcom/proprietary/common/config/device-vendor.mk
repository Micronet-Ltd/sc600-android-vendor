...
PRODUCT_LIST += $(MSMSTEPPE)_au_gvmq
...
CNE += com.quicinc.cne.server@2.3
...
CNE += vendor.qti.data.factory@1.1
...
CNE += com.quicinc.cne.server-V2.3-java
CNE += vendor.qti.data.factory-V1.0-java
CNE += vendor.qti.data.factory-V1.1-java
...
CVP += libcvp_system
CVP += libcvp_system.so
CVP += libcvp_stub_system
CVP += libcvp_stub_system.so
CVP += libcvp_common_system
CVP += libcvp_common_system.so
CVP += libcvpcpuRev_skel_system
CVP += libcvpcpuRev_skel_system.so
...
DISPLAY += libsdm-diag
DISPLAY += libhdr_tm
DISPLAY += libhdrdynamic
DISPLAY += libhdrdynamicootf
DISPLAY += libgtestext
DISPLAY += libxmlext
DISPLAY += libsdedrm
...
FINGERPRINT += init_qfp_daemon.rc
endif
...
LOC_HIDL_2_1_TARGET_LIST += msmnile
LOC_HIDL_2_1_TARGET_LIST += sdmshrike
LOC_HIDL_2_1_TARGET_LIST += $(MSMSTEPPE)
LOC_HIDL_2_1_TARGET_LIST += $(TRINKET)
...
GPS += vendor.qti.gnss@1.0-service.rc
...
GPS += vendor.qti.gnss@1.1-service.rc
...
GPS += vendor.qti.gnss@1.2-service.rc
...
GPS += vendor.qti.gnss@2.0-service.rc
...
GPS += vendor.qti.gnss@2.1-service.rc
...
HY11_HY22_diff += vendor.qti.hardware.vpp@1.2_vendor
...
MM_AUDIO += QRD_WCD9375_Bluetooth_cal.acdb
MM_AUDIO += QRD_WCD9375_Codec_cal.acdb
MM_AUDIO += QRD_WCD9375_General_cal.acdb
MM_AUDIO += QRD_WCD9375_Global_cal.acdb
MM_AUDIO += QRD_WCD9375_Handset_cal.acdb
MM_AUDIO += QRD_WCD9375_Hdmi_cal.acdb
MM_AUDIO += QRD_WCD9375_Headset_cal.acdb
MM_AUDIO += QRD_WCD9375_Speaker_cal.acdb
MM_AUDIO += QRD_WCD9375_workspaceFile.qwsp
...
MM_CAMERA += libchromatix_ov2680_zsl_video
...
MM_CAMERA += libchromatix_ov2718_a3_default_preview
MM_CAMERA += libchromatix_ov2718_a3_default_video
MM_CAMERA += libchromatix_ov2718_zsl_preview
MM_CAMERA += libchromatix_ov2718_zsl_video
...
MM_CAMERA += libchromatix_ov9284_a3_default_preview
MM_CAMERA += libchromatix_ov9284_a3_default_video
MM_CAMERA += libchromatix_ov9284_zsl_preview
MM_CAMERA += libchromatix_ov9284_zsl_video
...
MM_GRAPHICS += a618_zap.b00
MM_GRAPHICS += a618_zap.b01
MM_GRAPHICS += a618_zap.b02
MM_GRAPHICS += a618_zap.elf
MM_GRAPHICS += a618_zap.mdt
...
QCRIL += vendor.qti.hardware.radio.deviceinfo@1.0
...
QCRIL += qcrild
QCRIL += qcrild.rc
QCRIL += vendor.rild.rc
QCRIL += vendor.rild.legacy.rc
QCRIL += qcrild_librilutils
...
QMI += libmdmdetect
QMI += libqmiservices
QMI += libqmiservices_ext
QMI += libimsqmiservices
QMI += libqsocket
QMI += qmiproxy
QMI += qmi_config.xml
...
FACE3D += vendor.qti.hardware.biometrics.face@1.0
FACE3D += vendor.qti.hardware.biometrics.face@1.0-adapter-helper
FACE3D += vendor.qti.hardware.biometrics.face@1.0-service.rc
FACE3D += vendor.qti.hardware.biometrics.face@1.0-impl
FACE3D += vendor.qti.hardware.biometrics.face@1.0-service
FACE3D += libface3dhidl_client
FACE3D += libface3dhidl_client.so
FACE3D += Face3DSystemService
...
SECUREMSM += move_fido_session.sh
...
SECUREMSM += libGPMTEEC_system
SECUREMSM += libGPMTEEC_vendor
SECUREMSM += libGPQTEEC_system
...
TELEPHONY_APPS += ChinaMobileFrameworksRes
...
VPP += vendor.qti.hardware.vpp@1.2
VPP += vppservice
...
#MIRRORLINK core libs
MIRRORLINK := librpcclient
MIRRORLINK += libupnp
MIRRORLINK += libscreenrecord
MIRRORLINK += librpcserver
MIRRORLINK += librle
MIRRORLINK += libprotobuf-c
MIRRORLINK += libprotobuf-java_mls
MIRRORLINK += libmsg_wrapper
MIRRORLINK += libmls_rtps
MIRRORLINK += libmls_rtpc
MIRRORLINK += libmls_cdb
MIRRORLINK += libmls_plat_touch
MIRRORLINK += libmls_plat_screen
MIRRORLINK += libmls_plat_hardkey
MIRRORLINK += libmls_plat_connection
MIRRORLINK += libmls_plat_audio_in
MIRRORLINK += libmls_plat_audio_out
MIRRORLINK += libmls_plat_encode
MIRRORLINK += libmls_iface
MIRRORLINK += libmls_dispmgr
MIRRORLINK += libmls_devmgr
MIRRORLINK += libmls_dapmgr
MIRRORLINK += libmls_dataservicesmgr
MIRRORLINK += libmls_audmgr
MIRRORLINK += libmls_settingsmgr
MIRRORLINK += libavncs
MIRRORLINK += libaupnp
MIRRORLINK += libalesosal
MIRRORLINK += libcrypto_mls
MIRRORLINK += libmls_plat_dap
MIRRORLINK += vendor.qti.hardware.mlshal@1.0-halimpl
MIRRORLINK += vendor.qti.hardware.mlshal@1.0
MIRRORLINK += vendor.qti.hardware.mlshal@1.0_vendor
MIRRORLINK += vendor.qti.hardware.mlshal@1.0_system
MIRRORLINK += vendor.qti.hardware.mlshal@1.0-impl
MIRRORLINK += libmls_certmgr
MIRRORLINK += libxmlsec1
MIRRORLINK += libxmlsec1-openssl

#MIRRORLINK core executables
MIRRORLINK += vendor.qti.hardware.mlshal@1.0-service
MIRRORLINK += mlsdapprov
MIRRORLINK += mirrorlinkserver
MIRRORLINK += MLSAPIService

#MIRRORLINK reference app
MIRRORLINK += MLSSettings
MIRRORLINK += mlsconfig.xml
MIRRORLINK += MLcmdTable_English.xml

#MIRRORLINK init files
MIRRORLINK += vendor.qti.hardware.mlshal@1.0-service.rc
MIRRORLINK += mls.rc

#MIRRORLINK test executables
MIRRORLINK += test_screenrecord
MIRRORLINK += test_rtp_server
MIRRORLINK += test_mls_read_hardkey
MIRRORLINK += test_mls_plat_touch
MIRRORLINK += test_mls_plat_screen
MIRRORLINK += test_mls_plat_pointer
MIRRORLINK += test_mls_plat_hardkey
MIRRORLINK += test_mls_plat_dap
MIRRORLINK += test_mls_plat_connection
MIRRORLINK += test_mls_plat_audio_out
MIRRORLINK += test_mls_plat_audio_in
MIRRORLINK += test_aupnp_init
MIRRORLINK += test_aupnp_server_utils
MIRRORLINK += test_avncs
MIRRORLINK += test_cert_mgr
MIRRORLINK += test_msg_wrapper
MIRRORLINK += test_rleencode
MIRRORLINK += testrpcserver
...
ifneq ($(filter $(TARGET_PRODUCT), qcs605),$(TARGET_PRODUCT))
# NNHAL Stack Components
NNHAL = android.hardware.neuralnetworks@1.1-service-qti
NNHAL += android.hardware.neuralnetworks@1.1-service-qti.rc
...
VNDK_LIBS += vendor.display.color@1.3.vendor
...
VNDK_LIBS += vendor.qti.hardware.seccam@1.0.vendor
VNDK_LIBS += vendor.qti.hardware.biometrics.face@1.0.vendor
...
# CTS testcase check for vendor security path compliance date
