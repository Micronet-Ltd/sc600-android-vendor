...
)
{
  ...
  {
    case AF_INET:
      snprintf(buff, bufflen, formatstr, IPTABLES, iptables_options, nfo->proto, nfo->mark);
      break;

    case AF_INET6:
      snprintf(buff, bufflen, formatstr, IP6TABLES, iptables_options, nfo->proto, nfo->mark);
      break;
...
)
{
  ...
  switch(af)
  {
    case AF_INET:
      ...
      snprintf(buff, bufflen, formatstr, IPTABLES, iptables_options, saddr, nfo->mss);
      break;
...
nm_mdmprxy_set_iptables_command_options(void)
{
  ...
  (void) strlcpy(iptables_options, " -w", sizeof(iptables_options));
#else
