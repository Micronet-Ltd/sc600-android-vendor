...
static const struct nm_mdmprxy_cmd static_rule_list[] =
{
  ...
  { "%s %s -t mangle -I nm_mdmprxy_pkt_marker -j nm_mdmprxy_mngl_pre",
    "%s %s -t mangle -D nm_mdmprxy_pkt_marker -j nm_mdmprxy_mngl_pre",
    nm_mdmprxy_basic_formatter },
...
int nm_mdmprxy_common_mark_prov_netd_oos_hdlr(void)
{
  ...
  flush_pkt_marker_rules.rule = "%s %s -t mangle -F nm_mdmprxy_pkt_marker";
