...
//check BT MAC 00:00:00:00:00:00
if((modem_bdaddr_[0]|modem_bdaddr_[1]|modem_bdaddr_[2]|modem_bdaddr_[3]|modem_bdaddr_[4]|modem_bdaddr_[5]) == 0){
ALOGE("quectel break Read MODEM_NV_BD_ADDR");
QmiDmsCleanup();
break;
}
            valid_bda = true;
