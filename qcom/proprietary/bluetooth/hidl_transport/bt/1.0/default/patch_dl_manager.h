...
#define SCRAMBLING_FREQS_SIZE                64
/* HCI Socket options */
...
#define CHEROKEE_RAMPATCH_TLV_3_2_PATH    "/bt_firmware/image/crbtfw32.tlv"
#define CHEROKEE_NVM_TLV_3_2_PATH         "/bt_firmware/image/crnv32.bin"
...
#define COMANCHE_RAMPATCH_TLV_1_2_PATH    "/bt_firmware/image/cmbtfw12.tlv"
#define COMANCHE_NVM_TLV_1_2_PATH         "/bt_firmware/image/cmnv12.bin"
...
#define HASTINGS_RAMPATCH_TLV_1_0_PATH  "/bt_firmware/image/htbtfw10.tlv"
#define HASTINGS_NVM_TLV_1_0_PATH       "/bt_firmware/image/htnv10.bin"
#define HASTINGS_RAMPATCH_TLV_2_0_PATH  "/bt_firmware/image/htbtfw20.tlv"
#define HASTINGS_NVM_TLV_2_0_PATH       "/bt_firmware/image/htnv20.bin"
...
#define CHEROKEE_RAMPATCH_TLV_3_2_PATH_ALT    "/vendor/firmware/crbtfw32.tlv"
#define CHEROKEE_NVM_TLV_3_2_PATH_ALT         "/vendor/firmware/crnv32.bin"
...
#define COMANCHE_RAMPATCH_TLV_1_2_PATH_ALT   "/vendor/firmware/cmbtfw12.tlv"
#define COMANCHE_NVM_TLV_1_2_PATH_ALT        "/vendor/firmware/cmnv12.bin"
...
#define HASTINGS_RAMPATCH_TLV_1_0_PATH_ALT  "/vendor/firmware/htbtfw10.tlv"
#define HASTINGS_NVM_TLV_1_0_PATH_ALT       "/vendor/firmware/htnv10.bin"
#define HASTINGS_RAMPATCH_TLV_2_0_PATH_ALT  "/vendor/firmware/htbtfw20.tlv"
#define HASTINGS_NVM_TLV_2_0_PATH_ALT       "/vendor/firmware/htnv20.bin"

#define ROME_RAMPATCH_TLV_3_0_0_PATH_ALT_QTI      "/vendor/bt_firmware/image/btfw30.tlv"
#define ROME_NVM_TLV_3_0_0_PATH_ALT_QTI           "/vendor/bt_firmware/image/btnv30.bin"
#define ROME_RAMPATCH_TLV_3_0_2_PATH_ALT_QTI      "/vendor/bt_firmware/image/btfw32.tlv"
#define ROME_NVM_TLV_3_0_2_PATH_ALT_QTI           "/vendor/bt_firmware/image/btnv32.bin"

#define CHEROKEE_RAMPATCH_TLV_1_0_PATH_ALT_QTI    "/vendor/bt_firmware/image/crbtfw10.tlv"
#define CHEROKEE_NVM_TLV_1_0_PATH_ALT_QTI         "/vendor/bt_firmware/image/crnv10.bin"
#define CHEROKEE_RAMPATCH_TLV_1_1_PATH_ALT_QTI    "/vendor/bt_firmware/image/crbtfw11.tlv"
#define CHEROKEE_NVM_TLV_1_1_PATH_ALT_QTI         "/vendor/bt_firmware/image/crnv11.bin"
#define CHEROKEE_RAMPATCH_TLV_2_0_PATH_ALT_QTI    "/vendor/bt_firmware/image/crbtfw20.tlv"
#define CHEROKEE_NVM_TLV_2_0_PATH_ALT_QTI         "/vendor/bt_firmware/image/crnv20.bin"
#define CHEROKEE_RAMPATCH_TLV_2_1_PATH_ALT_QTI    "/vendor/bt_firmware/image/crbtfw21.tlv"
#define CHEROKEE_NVM_TLV_2_1_PATH_ALT_QTI         "/vendor/bt_firmware/image/crnv21.bin"
#define CHEROKEE_RAMPATCH_TLV_3_0_PATH_ALT_QTI    "/vendor/bt_firmware/image/crbtfw30.tlv"
#define CHEROKEE_NVM_TLV_3_0_PATH_ALT_QTI         "/vendor/bt_firmware/image/crnv30.bin"
#define CHEROKEE_RAMPATCH_TLV_3_2_PATH_ALT_QTI    "/vendor/bt_firmware/image/crbtfw32.tlv"
#define CHEROKEE_NVM_TLV_3_2_PATH_ALT_QTI         "/vendor/bt_firmware/image/crnv32.bin"


#define APACHE_RAMPATCH_TLV_0_0_5_PATH_ALT_QTI    "/vendor/bt_firmware/image/apbtfw05.tlv"
#define APACHE_NVM_TLV_0_0_5_PATH_ALT_QTI         "/vendor/bt_firmware/image/apnv05.bin"
#define APACHE_RAMPATCH_TLV_0_0_6_PATH_ALT_QTI    "/vendor/bt_firmware/image/apbtfw06.tlv"
#define APACHE_NVM_TLV_0_0_6_PATH_ALT_QTI         "/vendor/bt_firmware/image/apnv06.bin"
#define APACHE_RAMPATCH_TLV_1_0_0_PATH_ALT_QTI    "/vendor/bt_firmware/image/apbtfw10.tlv"
#define APACHE_NVM_TLV_1_0_0_PATH_ALT_QTI         "/vendor/bt_firmware/image/apnv10.bin"
#define APACHE_RAMPATCH_TLV_1_0_1_PATH_ALT_QTI    "/vendor/bt_firmware/image/apbtfw10.tlv"
#define APACHE_NVM_TLV_1_0_1_PATH_ALT_QTI         "/vendor/bt_firmware/image/apnv10.bin"
#define APACHE_RAMPATCH_TLV_1_0_2_PATH_ALT_QTI    "/vendor/bt_firmware/image/apbtfw10.tlv"
#define APACHE_NVM_TLV_1_0_2_PATH_ALT_QTI         "/vendor/bt_firmware/image/apnv10.bin"
#define APACHE_RAMPATCH_TLV_1_0_3_PATH_ALT_QTI    "/vendor/bt_firmware/image/apbtfw10.tlv"
#define APACHE_NVM_TLV_1_0_3_PATH_ALT_QTI         "/vendor/bt_firmware/image/apnv10.bin"
#define APACHE_RAMPATCH_TLV_1_1_0_PATH_ALT_QTI    "/vendor/bt_firmware/image/apbtfw11.tlv"
#define APACHE_NVM_TLV_1_1_0_PATH_ALT_QTI         "/vendor/bt_firmware/image/apnv11.bin"

#define NAPIER_RAMPATCH_TLV_1_0_PATH_ALT_QTI      "/vendor/bt_firmware/image/nrbtfw10.tlv"
#define NAPIER_NVM_TLV_1_0_PATH_ALT_QTI           "/vendor/bt_firmware/image/nrnv10.bin"
#define NAPIER_RAMPATCH_TLV_2_0_PATH_ALT_QTI      "/vendor/bt_firmware/image/nrbtfw20.tlv"
#define NAPIER_NVM_TLV_2_0_PATH_ALT_QTI           "/vendor/bt_firmware/image/nrnv20.bin"

#define COMANCHE_RAMPATCH_TLV_1_0_PATH_ALT_QTI   "/vendor/bt_firmware/image/cmbtfw10.tlv"
#define COMANCHE_NVM_TLV_1_0_PATH_ALT_QTI        "/vendor/bt_firmware/image/cmnv10.bin"
#define COMANCHE_RAMPATCH_TLV_1_0_1_PATH_ALT_QTI "/vendor/bt_firmware/image/cmbtfw10.tlv"
#define COMANCHE_NVM_TLV_1_0_1_PATH_ALT_QTI      "/vendor/bt_firmware/image/cmnv10.bin"
#define COMANCHE_RAMPATCH_TLV_1_1_PATH_ALT_QTI   "/vendor/bt_firmware/image/cmbtfw11.tlv"
#define COMANCHE_NVM_TLV_1_1_PATH_ALT_QTI        "/vendor/bt_firmware/image/cmnv11.bin"
#define COMANCHE_RAMPATCH_TLV_1_2_PATH_ALT_QTI   "/vendor/bt_firmware/image/cmbtfw12.tlv"
#define COMANCHE_NVM_TLV_1_2_PATH_ALT_QTI        "/vendor/bt_firmware/image/cmnv12.bin"
...
#define HASTINGS_RAMPATCH_TLV_1_0_PATH_ALT_QTI  "/vendor/bt_firmware/image/htbtfw10.tlv"
#define HASTINGS_NVM_TLV_1_0_PATH_ALT_QTI       "/vendor/bt_firmware/image/htnv10.bin"
#define HASTINGS_RAMPATCH_TLV_2_0_PATH_ALT_QTI  "/vendor/bt_firmware/image/htbtfw20.tlv"
#define HASTINGS_NVM_TLV_2_0_PATH_ALT_QTI       "/vendor/bt_firmware/image/htnv20.bin"
...
enum {
  ...
  CHEROKEE_VER_2_1_1 = QCA_BT_VER(PROD_ID_CHEROKEE, CHEROKEE_BUILD_VER_0211, QCA_CHEROKEE_SOC_ID_0211),
  CHEROKEE_VER_3_0 = QCA_BT_VER(PROD_ID_CHEROKEE, CHEROKEE_BUILD_VER_0300, QCA_CHEROKEE_SOC_ID_0300),
  CHEROKEE_VER_3_1 = QCA_BT_VER(PROD_ID_CHEROKEE, CHEROKEE_BUILD_VER_0310, QCA_CHEROKEE_SOC_ID_0310),
  CHEROKEE_VER_3_2 = QCA_BT_VER(PROD_ID_CHEROKEE, CHEROKEE_BUILD_VER_0302, QCA_CHEROKEE_SOC_ID_0320),
};
...
enum {
  ...
  APACHE_VER_1_2_0 = QCA_BT_VER(PROD_ID_APACHE, APACHE_BUILD_VER_0120, QCA_APACHE_SOC_ID_0120),
  APACHE_VER_1_2_1 = QCA_BT_VER(PROD_ID_APACHE, APACHE_BUILD_VER_0120, QCA_APACHE_SOC_ID_0121),
};
...
enum {
    ...
    COMANCHE_VER_1_2   = QCA_BT_VER(PROD_ID_COMANCHE, COMANCHE_BUILD_VER_0120, QCA_COMANCHE_SOC_ID_0120),
};
...
enum {
  AUDIO_CODEC_SAMPLE_RATE_NONE   = 0x0,
  AUDIO_CODEC_SAMPLE_RATE_44100  = 0x1 << 0,
  AUDIO_CODEC_SAMPLE_RATE_48000  = 0x1 << 1,
  AUDIO_CODEC_SAMPLE_RATE_88200  = 0x1 << 2,
  AUDIO_CODEC_SAMPLE_RATE_96000  = 0x1 << 3,
  AUDIO_CODEC_SAMPLE_RATE_176400 = 0x1 << 4,
  AUDIO_CODEC_SAMPLE_RATE_192000 = 0x1 << 5
};

#define IS_NEWER_THAN_CHEROKEE_2_1(v)  (((v) >= NAPIER_VER_1_0_0) ||\
                                       (((uint8_t) (((v) & 0x00F00000) >> 20) == PROD_ID_CHEROKEE) \
                                       && ((uint16_t) ((v) & 0x0FFF) >= CHEROKEE_BUILD_VER_0300)))
enum {
  HASTINGS_BUILD_VER_0100 = 0x0100,
...
enum {
  HASTINGS_VER_1_0   = QCA_BT_VER(PROD_ID_HASTINGS, HASTINGS_BUILD_VER_0100, QCA_HASTINGS_SOC_ID_0100),
  HASTINGS_VER_1_0_1 = QCA_BT_VER(PROD_ID_HASTINGS, HASTINGS_BUILD_VER_0100, QCA_HASTINGS_SOC_ID_0101),
  HASTINGS_VER_1_1   = QCA_BT_VER(PROD_ID_HASTINGS, HASTINGS_BUILD_VER_0100, QCA_HASTINGS_SOC_ID_0110),
  HASTINGS_VER_2_0   = QCA_BT_VER(PROD_ID_HASTINGS, HASTINGS_BUILD_VER_0200, QCA_HASTINGS_SOC_ID_0200),
};
...
class PatchDLManager {
 ...
 private:
  ...
  bool unified_hci;
  uint8_t add_on_feat_mask_len = 0;
