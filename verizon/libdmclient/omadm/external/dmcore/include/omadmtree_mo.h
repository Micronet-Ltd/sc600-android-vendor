 ...
 */
//cody typedef int (*omadm_mo_init_fn) (void ** dataP);
 ...
 */
//cody typedef void (*omadm_mo_close_fn) (void * data);
 ...
 * @returns a SyncML error code
 */
//cody typedef int (*omadm_mo_is_node_fn) (const char * uri, omadmtree_node_kind_t * type, void * data);
 ...
 * @returns a SyncML error code
 */
//cody typedef int (*omadm_mo_find_urn_fn) (const char * urn, char *** urlsP, void * data);
 ...
 * @returns a SyncML error code
 */
//cody typedef int (*omadm_mo_get_fn) (dmtree_node_t * nodeP, void * data);
 ...
 * @returns a SyncML error code
 */
//cody typedef int (*omadm_mo_set_fn) (const dmtree_node_t * nodeP, void * data);
 ...
 * @returns a SyncML error code
 */
//cody typedef int (*omadm_mo_get_ACL_fn) (const char * uri, char ** aclP, void * data);
 ...
 * @returns a SyncML error code
 */
//cody typedef int (*omadm_mo_set_ACL_fn) (const char * uri, const char *acl, void * data);
 ...
 * @returns a SyncML error code
 */
//cody typedef int (*omadm_mo_rename_fn) (const char * from, const char * to, void * data);
 ...
 * @returns a SyncML error code
 */
//cody typedef int (*omadm_mo_delete_fn) (const char * uri, void * data);
 ...
 * @returns a SyncML error code
 */
//cody typedef int (*omadm_mo_exec_fn) (const char * uri, const char * cmdData, const char * correlator, void * data);
