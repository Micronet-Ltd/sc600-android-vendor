...
#define PAL_RC_FRMW_DOWNLOAD_ERROR_VERIFICATION_FAILED      ((int)7)
#define PAL_RC_FRMW_DOWNLOAD_SERVER_UNAVAILABLE             ((int)8)
#define PAL_RC_FRMW_DOWNLOAD_PACKAGE_NOT_ACCEPTABLE         ((int)9)
#define FUMO_RC_PRV_SU_CANCEL                               ((int)10)
#define FUMO_RC_PRV_SU_CANCEL_BEFORE_DEFERRED_EVENT         ((int)11)
#define FUMO_RC_PRV_SU_CANCEL_AFTER_UPDATE                  ((int)12)
#define FUMO_RC_PRV_DOWNLOAD_NO_NETWORK                     ((int)13)
#define FUMO_RC_PRV_DOWNLOAD_WIFI_TIMEOUT                   ((int)14)
#define FUMO_RC_PRV_INSTALL_CANCELLED                       ((int)15)
#define FUMO_RC_PRV_DOWNLOAD_CANCELLED                      ((int)16)
#define FUMO_RC_PRV_NOT_AVAILABLE_MEMORY                    ((int)17)
 ...
 */
#define FUMO_DOWNLOAD_FILE_SIZE ((unsigned long int)53000000)
/**
