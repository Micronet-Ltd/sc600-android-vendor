...
static plugin_tree_node_t gNodes[] =
{
    {PRV_BASE_URI, PRV_URN,
            ...
            "Get=*", "", NULL, NULL, NULL},
    {PRV_BASE_URI"/DevId", NULL,
            OMADM_LEAF_FORMAT_CHAR, OMADM_LEAF_TYPE,
            "Get=*", "", "pal_system_dev_id_get", NULL, NULL},
    {PRV_BASE_URI"/Man", NULL,
            OMADM_LEAF_FORMAT_CHAR, OMADM_LEAF_TYPE,
            "Get=*", "", "pal_system_man_get", NULL, NULL},
    {PRV_BASE_URI"/Mod", NULL,
            OMADM_LEAF_FORMAT_CHAR, OMADM_LEAF_TYPE,
            "Get=*", "", "pal_system_mod_get", NULL, NULL},
    {PRV_BASE_URI"/DmV", NULL,
            OMADM_LEAF_FORMAT_CHAR, OMADM_LEAF_TYPE,
            "Get=*","", "pal_system_dmv_get", NULL, NULL},
    {PRV_BASE_URI"/Lang", NULL,
            OMADM_LEAF_FORMAT_CHAR, OMADM_LEAF_TYPE,
            "Get=*","", "pal_system_lang_get", NULL, NULL},
    {PRV_BASE_URI"/Ext", NULL,
            OMADM_NODE_FORMAT,OMADM_NODE_TYPE,
            "Get=*","ICCID", NULL, NULL, NULL},
    {PRV_BASE_URI"/Ext/ICCID", NULL,
            OMADM_LEAF_FORMAT_CHAR, OMADM_LEAF_TYPE,
            "Get=*", "NULL",
            "pal_system_iccid_get", NULL, NULL},
                     ...
                     void * iData)
{
    ...
    if (!palHandle){
        DM_LOGE( "ERROR! PAL isn't loaded. : %s (line %d)", __FILE__, __LINE__);
    ...
    if(nodeP) {
        //iData not contain any info about size, array and checked by spesific "tail node"
        while(nodes[i].uri && strcmp(nodes[i].uri, "NULL")) {
...
static int prv_set_fn(const dmtree_node_t * nodeP,
                     void * iData)
{
    if(iData!=NULL ||nodeP!=NULL)DM_LOGI("prv_set_fn dmtree_node_t: nodeP ");
