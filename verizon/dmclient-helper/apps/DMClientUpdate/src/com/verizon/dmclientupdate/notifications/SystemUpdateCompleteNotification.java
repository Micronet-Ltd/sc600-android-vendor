...
public class SystemUpdateCompleteNotification {
    private NotificationManager notificationManager;
    private static SystemUpdateCompleteNotification sSystemUpdateCompleteNotification = null;

    public static SystemUpdateCompleteNotification getInstance() {
        if (sSystemUpdateCompleteNotification == null) {
            sSystemUpdateCompleteNotification = new SystemUpdateCompleteNotification();
        }
        return sSystemUpdateCompleteNotification;
    }
    public void show(Context context){
        RemoteViews contentView = new RemoteViews(context.getPackageName(), R.layout.custom_notification_layout_system_update_complete);
