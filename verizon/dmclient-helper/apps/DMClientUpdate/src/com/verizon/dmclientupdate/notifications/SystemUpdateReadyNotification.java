...
public class SystemUpdateReadyNotification {
    private NotificationManager notificationManager;
    private static SystemUpdateReadyNotification sSystemUpdateReadyNotification = null;

    public static SystemUpdateReadyNotification getInstance() {
        if (sSystemUpdateReadyNotification == null) {
            sSystemUpdateReadyNotification = new SystemUpdateReadyNotification();
        }
        return sSystemUpdateReadyNotification;
    }
    public void show(Context context){
        RemoteViews contentView = new RemoteViews(context.getPackageName(), R.layout.custom_notification_layout_system_update_ready);
