...
public class DownloadFailNotification {
    protected NotificationManager notificationManager;
    protected static final String TAG = "DownloadingNotification";

    protected static DownloadFailNotification sDownloadingNotification = null;
    protected Utils mUtils = Utils.getInstance(App.getContext());

    public static DownloadFailNotification getInstance() {
        if (sDownloadingNotification == null) {
            sDownloadingNotification = new DownloadFailNotification();
        }
    ...
    public void show(Context context){
        ...
        RemoteViews contentView = new RemoteViews(context.getPackageName(), R.layout.custom_notification_layout_download_fail);
        ...
        Notification notification = mNotifyBuilder
                ...
                .setContentText(resources.getString(R.string.download_system_update_fail))
